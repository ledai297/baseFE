    ...
    return (
        <>
            <Button className="pull-left" onClick={handleClickOpenDialog} style={{ alignItems: "end" }}>
                ...
                <span>Điều chỉnh hiển thị cột</span>
            </Button>
            <Dialog open={openDialog} onClose={handleCloseDialog} maxWidth="sm" fullWidth={true}>
                <DialogTitle id="form-dialog-title">Điều chỉnh hiển thị cột</DialogTitle>
                ...
                <div style={{ borderTop: "1px solid #ddd", fontSize: "14px" }}>
                    ...
                    <DialogActions style={{ borderTop: "1px solid #ddd", fontSize: "14px" }}>
                         <div className="w-100">
                            <span style={{ fontWeight: "bold" }}>Lưu ý: </span>Di chuột vào và kéo thả các ô để thay đổi thứ tự vị trí các cột hiển thị trên trang danh sách
                        </div>
                        <Link className="btn sapo-btn-blank none-text-decoration" onClick={handleCloseDialog}>Thoát</Link>
